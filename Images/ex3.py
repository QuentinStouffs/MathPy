...
#                                                                      #
#                           Ex 2.3 Enoncé                              #
#   récupérer une partie d'une image.
# Pour cela il suffit de ne conserver qu'une partie de notre
# tableau de données.
# C'est très facile avec un tableau numpy : image[2:6,3:9] permet de
# récupérer la zone entre la ligne 2 et 5 et la colonne 3 et 8
# (en python on ne prend pas la dernière valeur).
# Si on souhaite récupérer le regard de Lenna512, on peut récupérer
# la zone entre les lignes 240 et 290 et les colonnes 240 et 360.      #
#                                                                      #                                                               #
#----------------------------------------------------------------------#
