...
#                           Ex 2.3 Enoncé                              #
#image miroir
# Pour retourner une image (inverser gauche-droite: la colonne 0
# devient la 511, la 1 devient la 510, la 2, 509), il suffit simplement
# que sur chaque ligne, on mette dans le pixel situé à la colonne col
# la valeur
# du pixel de la colonne (nb_colonnes-1)-col de l'image originale.    #
#                                                                      #                                                               #
#----------------------------------------------------------------------#
...
#         image_sortie[row, col] = image[row, nb_colonnes-1-col]
#Simplification :

for i in range(image_sortie.shape[1]) :
    image_sortie[:, i] = image[:, -i]
