...
#                           Ex 2.6 Enoncé                              #
# isoller une couleur
#A partir d'une image, on peut isoler une seule composante de couleur,
# le rouge par exemple.
# On peut aussi créer 3 images différentes dans lesquelles on ne garde à
# chaque fois que la composante rouge, verte ou bleue de chaque pixel.
# L'image originale étant en fait la superposition des trois.          #
#                                                                      #                                                               #
#----------------------------------------------------------------------#
...
for row in range(nb_lignes) :
    for col in range(nb_colonnes) :
            image_sortie[row, col] = image_sortie[row, col]*[0,1,0]
