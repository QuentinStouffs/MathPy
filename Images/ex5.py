...
#                           Ex 2.5 Enoncé                              #
# image en négatif
# Pour inverser les couleurs (faire un négatif) , il suffit de
# remplacer chaque couleur (le rouge, le vert et le bleu) de valeur v
# par la valeur 255 – v (le complément à 255).                         #
#                                                                      #                                                               #
#----------------------------------------------------------------------#
...
for row in range(nb_lignes) :
    for col in range(nb_colonnes) :
        for i in range(len(image_sortie[row, col])) :
            image_sortie[row, col][i] = 255-image_sortie[row, col][i]
